...
public class BorsaTest {
	...
	assertEquals(Piuma2.getNome(), l.get(1).getNome());
	...
	public void testOrdinatoNome() {
		b.removeAttrezzo("moneta");
		assertFalse(b.equals(b.getAttrezzo("moneta")));
		assertEquals(List.of(libro,piombo,piuma,piuma2), new ArrayList<>(this.alfabetica.....));

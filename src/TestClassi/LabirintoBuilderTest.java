...
public class LabirintoBuilderTest {
	...
	public void testMonolocaleConAttrezzoSingoloDuplicato() {
		...
		HashSet<Attrezzo> sp = new HashSet<>();
		sp.add(spada);
		assertEquals(sp,monolocale.getStanzaIniziale().getAttrezzi());
	...
	public void testPiuDiQuattroAdiacenti() {
		Labirinto maze = labirintoBuilder
				...
				.getLabirinto();
				 Stanza test = new Stanza("stanza5 ");
	...
	*/
	...
	public void testLabirintoConStanzaMagica_AggiuntaElementoOltreSogliaMagica() {
		...
		Attrezzo pippo = new Attrezzo(nomeAttrezzo2Inv,peso2_x2);
		assertEquals(pippo, listaStanze.get(nomeStanzaMagica).getAttrezzo(nomeAttrezzo2Inv));
	}
